...
horasPmes = np.array([744.00, 672.00, 744.00, 720.00, 744.00,
                     720.00, 744.00, 744.00, 720.00, 744.00, 720.00, 744.00])
...
energiaGerada1 = np.array([33.83, 34.90, 35.44, 35.11, 38.93, 44.30,
                          47.14, 46.71, 45.64, 43.22, 36.78, 37.58])  # em MWmed_mês
...
def genetic_algorithm():
    ...
    calculoContratos(horasPmes, pld, energiaGerada1, sazonalidadeC1, sazonalidadeC2,
                     best_solution, precoC1, precoC2, controle, receitaC1, receitaC2, receitaTotalSobra)
